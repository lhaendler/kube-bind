...
func TestAnnotationsAdded(t *testing.T) {
	...
	assertAnnotation(t, consumerUpdate, "kube-bind.io/bound", "true")
	assertAnnotation(t, providerUpdate, "kube-bind.io/bound", "true")
}
...
func TestCreate(t *testing.T) {
	...
	assertAnnotation(t, createdObj, "kube-bind.io/bound", "true")
	require.NoError(t, err, "reconcile should succeed")
}
